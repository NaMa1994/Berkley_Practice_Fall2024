from transformers import AutoFeatureExtractor, AutoModelForMaskedImageModeling, Trainer, TrainingArguments
...
print(ds)  # This will print information about the dataset splits, features, etc.
print(ds["train"].features)  # This shows you the features of each sample
...
feature_extractor = AutoFeatureExtractor.from_pretrained("microsoft/simmim-base-1k")
